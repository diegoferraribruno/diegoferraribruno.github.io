var usuarios = [{
    ...
    <br><br>•Resumo Profissional:
        ...
        <br>• 2008 - Web-Design, Modelagem 3D na Tedesco Comunicação. (3 meses)
        ...
        <br>• 2002 - Web Flash ferramentas básicas (Senac)
        <br>• 2003 - Oficina de Lightwave 3D (Senac)
        <br>• 2007 - Inglês - Cultura inglesa
        <br>• 2007 - In Design CS2 - Diagramação e Fechamento de Arquivo (Senac)
        <br>• 2007 - Marketing e empreendedorismo (Senac)
        ...
        <br>• 2012 - Oficina de bioconstrução com Bambu Gigante
        <br>• 2013 - oficina de bioconstrução de forno a lenha.
        <br>• 2013 - oficina de construção de banheiro seco
        <br>• 2013 - Curso de meditação Vipassana 10 dias
        <br>• 2014 - Oficina de Viveirista
        <br>• 2014 - curso de massagem relaxante ayurvedica.
        <br>• 2015 - oficina disciplina positiva para crianças
        ...
        <br>• Adobe InDesign (Diagramação)
        <br>• Adobe DreamWeaver (web-design e programação para web)
        <br>• Adobe Flash (web design, ilustração e animação)
        ...
        <br>• Programa de desenvolvimento de games Godot Engine.
