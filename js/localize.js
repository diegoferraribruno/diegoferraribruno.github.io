...
function localize() {
  if (language == "pt_BR") {
    language = "en";
    iD("localize").innerHTML = '<span class="icon2 bricon"></span>';
  } else {
    language = "pt_BR";
    iD("localize").innerHTML = '<span class="icon2 enicon"></span>';
  }
  Array.from(document.querySelectorAll("txt")).forEach(function (el) {
...
function localizeTitles() {
  Array.from(getAllElementsWithAttribute("title")).forEach(function (el) {
...
let textos = {
  pt_BR: {
    ...
    107: "Linha da animação",
    108: "Remover Linha da animação",
    109: "Espelhar o quadro",
  },
  en: {
