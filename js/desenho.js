...
function infinityPaint() {
  ...
  if (infinitypaint == true) {
    iD("infinity").innerHTML =
      '<span class="icon infinityicon"><span class="minicheck"></span></span>';
...
function Mirror() {
  ...
  if (mirror == true) {
    iD("mirror").innerHTML =
      '<span class="icon mirroricon"><span class="minicheck"></span></span>';
    setCenter();
    drawVerticalLine();
    Alert(
...
function Mandala() {
  mandala = !mandala;
  if (mandala == true) {
    iD("mandala").innerHTML =
      '<span class="icon mandalaicon"><span class="minicheck"></span></span>';
    setCenter();
    mostraMenu("mandala");
    drawSlices();
    Alert(
...
async function desenha(
  ...
  if (undoLevel != 0) {
    ...
    for (i = dif; i < historia[current][workingframe].length; i++) {
      historia[current][workingframe].pop();
    }
    undoLevel = 0;
  ...
  switch (CMD) {
    ...
    case "brush":
      ...
      if (infinitypaint == true) {
        ...
        if (X < newStrokeWidth / 2 && Y < newStrokeHeight) {
          //top left
          setTimeout(() => {
            //top right
            drawBrush(
          ...
          X > canvas.width - newStrokeWidth / 2 &&
          Y < newStrokeHeight
        ) {
          //top right
          setTimeout(() => {
          ...
          X < newStrokeWidth / 2 &&
          Y > canvas.height - newStrokeHeight / 2
        ) {
          //bottom left
          setTimeout(() => {
            //bottom right
          ...
          X > canvas.width - newStrokeWidth / 2 / 2 &&
          Y > canvas.height - newStrokeHeight / 2
        ) {
          //bottom right
          setTimeout(() => {
    ...
    case "f":
      ...
      myImg.onload = function () {
        ...
        changeGCO(GCO);
        context.drawImage(myImg, Y, eoX, myImg.width, myImg.height);
        // comandos[workingframe].push(comando)
        changeGCO(oldGCO);
    ...
    case "e":
      ...
      if (infinitypaint == true) {
        ...
        if (X < eoY / 2 && Y < eoY / 2) {
        ...
        } else if (X > canvas.width - eoY / 2 && Y < eoY - 2) {
          //top right
          setTimeout(() => {
            //top left
            // comando =["e", GCO, X - canvas.width, Y, eoX, eoY]
        ...
        } else if (X < eoY / 2 && Y > canvas.height - eoY / 2) {
          //bottom left
          setTimeout(() => {
            //bottom right
          ...
          X > canvas.width - eoY / 2 / 2 &&
          Y > canvas.height - eoY / 2
        ) {
          //bottom right
          setTimeout(() => {
            //bottom left
...
function backPaint() {
  if (globalComposite != "destination-over") {
    ...
    iD(
      "globalComposite"
    ).innerHTML = `<span class="icon2 paintundericon"></span>`;
    ...
    iD(
      "globalComposite"
    ).innerHTML = `<span class="icon2 paintovericon"></span>`;
